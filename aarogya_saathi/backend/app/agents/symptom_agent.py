        ...
        self.symptom_database = {
            ...
            "fever": {
                ...
                "questions": [
                    ...
                    "Any other symptoms like body pain or headache?",
                ],
            },
            # Cough related
            "cough": {
            ...
            "cold": {
                ...
                "questions": [
                    "Any fever with cold?",
                    "How many days have you had cold?",
                ],
            },
            # Headache related
            "headache": {
                ...
                "questions": [
                    ...
                    "How severe on scale of 1-10?",
                    "Any nausea or vision problems?",
                ],
            },
            # Stomach related
            "stomach": {
            ...
            "body_pain": {
                ...
                "questions": [
                    "Any fever with body pain?",
                    "Which area hurts most?",
                    "Did you do any heavy work recently?",
                ],
            },
            # Breathing issues
            "breathing": {
                ...
                "questions": [
                    ...
                    "Any chest pain?",
                    "Do you have asthma or heart condition?",
                ],
                "priority": "HIGH",
            },
            # Chest pain
            "chest": {
                ...
                "questions": [
                    "Does pain radiate to arm or jaw?",
                    "Any sweating?",
                    "Difficulty breathing?",
                ],
                "priority": "CRITICAL",
            ...
            "diabetes": {
                ...
                "questions": [
                    ...
                    "When did you last check sugar levels?",
                    "Any unusual thirst or urination?",
                ],
            },
            # BP related
            "bp": {
                ...
                "questions": [
                    "Do you have BP history?",
                    "What was last BP reading?",
        ...
        for symptom_name, symptom_data in self.symptom_database.items():
            if any(keyword in text for keyword in symptom_data["keywords"]):
                ...
                if symptom_data.get("priority") == "CRITICAL":
                    ...
                    symptom_data.get("priority") == "HIGH"
                    and self.priority != "CRITICAL"
                ):
                    self.priority = "HIGH"
